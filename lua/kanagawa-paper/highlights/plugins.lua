...
function M.setup(colors, opts)
	...
	return {
		...
		BufferInactiveBtn = { fg = theme.ui.fg_dim, bg = theme.ui.bg_tabline },
		...
		BufferInactiveNumber = { link = "BufferInactive" },
		...
		BufferCurrentIndex = { link = "BufferLineNumbersSelected" },
		BufferCurrentNumber = { link = "BufferLineNumbersSelected" },
		...
		BufferAlternateNumber = { link = "BufferAlternate" },
