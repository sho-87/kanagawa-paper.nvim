...
M.get = function(opts, palette)
	return {
		...
		vcs = {
			...
			added_light = color(palette.dragonGreen):blend(palette.sumiInk3, 0.95):to_hex(),
			removed = palette.dragonRed,
			removed_light = color(palette.dragonRed):blend(palette.sumiInk3, 0.95):to_hex(),
			changed = palette.dragonYellow,
			changed_light = color(palette.dragonYellow):blend(palette.sumiInk3, 0.95):to_hex(),
		},
		diff = {
			add = palette.dragonGreen,
			add_light = color(palette.dragonGreen):blend(palette.sumiInk3, 0.95):to_hex(),
			delete = palette.dragonRed,
			delete_light = color(palette.dragonRed):blend(palette.sumiInk3, 0.95):to_hex(),
			change = palette.dragonYellow,
			change_light = color(palette.dragonYellow):blend(palette.sumiInk3, 0.95):to_hex(),
			text = palette.dragonBlue,
			text_light = color(palette.dragonBlue):blend(palette.sumiInk3, 0.95):to_hex(),
		},
		diag = {
			error = palette.dragonRed,
			error_light = color(palette.dragonRed):blend(palette.sumiInk3, 0.95):to_hex(),
			ok = palette.dragonGreen,
			ok_light = color(palette.dragonGreen):blend(palette.sumiInk3, 0.95):to_hex(),
			warning = palette.dragonYellow,
			warning_light = color(palette.dragonYellow):blend(palette.sumiInk3, 0.95):to_hex(),
			info = palette.dragonBlue,
			info_light = color(palette.dragonBlue):blend(palette.sumiInk3, 0.95):to_hex(),
			hint = palette.dragonAqua,
			hint_light = color(palette.dragonAqua):blend(palette.sumiInk3, 0.95):to_hex(),
		},
		term = {
